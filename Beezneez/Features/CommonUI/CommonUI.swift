...
//  TemplateApp
//
//  Created by Colin Morrison on 28/06/2023.
//

import SwiftUI

// A bunch of tiny UI Components that are quite generic and can be used for quick concepts
...
struct RoundedCorner: Shape {
    ...
    /// Allows us to round one corner of a shape
